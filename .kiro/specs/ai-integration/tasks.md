...
- [x] 2. Implement LLM Client
  ...
  - [x] 2.4 Write property test for exponential backoff
...
- [x] 3. Integrate existing Memory System with AI
...
- [x] 4. Implement Context Manager
  ...
  - [x] 4.2 Integrate user memory into context building
  ...
  - [x] 4.4 Write property test for context history inclusion
  ...
  - [x] 4.7 Write property test for context reset on conversation change
    - **Property 10: Context reset on conversation change**


    - **Validates: Requirements 5.4**

  - [x] 4.8 Write property test for context exclusion when disabled
    - **Property 11: Context exclusion when disabled**
    - **Validates: Requirements 5.5**
  - [x] 4.9 Write property test for memory formatting in context
...
- [x] 7. Implement Settings Manager
  ...
  - [x] 7.4 Write property test for temperature clamping
...
- [x] 9. Implement Settings UI
  - [x] 9.1 Add settings panel HTML to src/renderer/index.html
  ...
  - [x] 9.2 Add settings panel styles to src/renderer/styles.css
    ...
    - _Requirements: 3.2_
  - [x] 9.3 Implement settings panel logic in src/renderer/renderer.ts
...
- [x] 10. Add IPC handlers for settings
  - [x] 10.1 Update src/preload/preload.ts with settings APIs
  ...
  - [x] 10.2 Add IPC handlers in src/main/main.ts
    - Handle get-ai-settings, save-ai-settings, test-llm-connection
    - Wire up to Settings Manager
    - _Requirements: 3.4, 3.5, 7.2_
  - [x] 10.3 Write property test for settings hot-reload


    - **Property 6: Settings hot-reload**
    - **Validates: Requirements 2.5, 4.5**

- [x] 11. Enhance existing Memory UI for AI context

  - [x] 11.1 Update memories section to show AI context preview
...
- [x] 12. Update configuration file
  - [x] 12.1 Update config.json with default AI settings
...
- [x] 14. Write property test for connection status accuracy
